...
public class IntervalsPrediction implements Prediction, Serializable {
    protected DoubleVector[] prediction;

    public IntervalsPrediction() {
        this(0);
    }

    public IntervalsPrediction(int numOutputAttributes) {
    ...
    public String toString(){
        String[] label = {"Prediction", "Lower Bound", "Upper Bound"};
